<?php // $Id: assign.php,v 1.7 2011/11/09 09:50:05 shtifanov Exp $
    ...
    /// Get all existing participants in this context.
        ...
        if ($searchtext !== '') {   // Search for a subset of remaining users
			...
			if ($searchtext !== '') { 
            	...
            	$usercount = '1000...';  // change by shtifanov
			}

        echo '<div align=center class="selector">';
        $assignableroles = array('0'=>get_string('listallroles', 'role').'...') + $assignableroles;
        popup_form("$CFG->wwwroot/blocks/mou_school/roles/assign.php?userid=$userid&amp;courseid=$courseid&amp;contextid=$contextid&amp;roleid=",
