<?php // $Id: discipline.php,v 1.25 2010/08/23 08:48:03 Shtifanov Exp $
...
function table_discipline ($yid, $rid, $sid)
{
	...
	$table->head  = array (	get_string('obrazovatobl', 'block_mou_school'), get_string('predmet', 'block_mou_school'),
	...
	$table->size = array ('20%', '30%', '10%', '5%','5%');
	$table->columnwidth = array (20, 35, 15, 15);    
               ...
               if ($disciplines = get_records_sql("SELECT * FROM {$CFG->prefix}monit_school_discipline 
	               ...
	               foreach ($disciplines as $discipline) {
	                   ...
	                   if ($discipline->dgroupid != 0)	{
						...
						$table->data[] = array ($strdsm, $strnamedisc, $discipline->shortname, $strsubgroups, $strlinkupdate);
